...
class LocationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($i = 0; $i < 50; $i++) {
            ...
            $plot->geom = "POINT(-" . $faker->randomFloat(3, 42, 57) . " -" . $faker->randomFloat(3, 3, 21) . ")";
            $plot->save();
        }
        // points
        for ($i = 0; $i < 500; $i++) {
            ...
            $point->geom = "POINT(-" . $faker->randomFloat(3, 42, 57) . " -" . $faker->randomFloat(3, 3, 21) . ")";
            $point->save();
        }
    }
}
