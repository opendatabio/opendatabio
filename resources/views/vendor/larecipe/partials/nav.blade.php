<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://github.com/opendatabio/opendatabio" target="__blank" type="black" class="mx-2 px-4">
            ...
            @auth
                ...
                <larecipe-dropdown>
                    <larecipe-button type="white" class="ml-2">
                        {{ auth()->user()->email ?? 'Account' }} <i class="fa fa-angle-down"></i>
                    </larecipe-button>

                    <template slot="list">
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="py-2 px-4 text-white bg-danger inline-flex">
