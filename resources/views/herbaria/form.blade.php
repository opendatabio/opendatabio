...
<div class="form-group">
    <label for="acronym" class="col-sm-3 control-label">@lang('messages.acronym')</label>
...
<div class="form-group">
    <label for="name" class="col-sm-3 control-label">@lang('messages.institution')</label>
    <div class="col-sm-6">
	<input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" readonly>
    </div>
</div>
<div class="form-group">
    <label for="irn" class="col-sm-3 control-label">@lang('messages.irn')</label>
	    <div class="col-sm-6">
