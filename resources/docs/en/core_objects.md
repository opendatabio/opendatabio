...
> {success} **Data access**: [Full users](dataaccess_objects#users) are able to register new taxons and edit existing records if not used. Currently it is impossible to remove a taxon from the database.
  <br>
