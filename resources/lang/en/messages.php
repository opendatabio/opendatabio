...
return array (
  ...
  'auxiliary' => 'Others',
  'traits' => 'Traits',
  'traits_hint' => 'Traits are variables that can be measured on plants, herbarium samples, locations and taxons. A trait definition must be as precise as possible.',
  'unit' => 'Unit',
  'detail' => 'Details',
  ...
  'users_hint' => 'This table represent the system users. Each user has a valid e-mail and password, and an access level, which
        ...
        plant or herbarium sample collectors or specialists. Use the "Persons" tab for that.',
...
remove the job information from the database.',
  ...
  'person_hint' => 'This table represent people which may or may not be directly involved with the database.
        It is used to store information about plant and herbarium sample collectors, specialists, and database users.
        When registering a new person, the system suggests the name abbreviation, but the user is free to change
        it to better adapt it to the usual abbreviation used by each person.
        The abbreviation should be unique for each person.',
  ...
  'voucher_parent_location_hint' => 'If the plant from which the sample was taken is not registered in the database, select here the Location where this sample was collected',
  ...
  'vouchers_hint' => 'This table represent herbarium samples, which are pressed plant samples deposited for future reference in herbaria.',
