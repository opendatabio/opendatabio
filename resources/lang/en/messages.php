...
return array (
  ...
  'creativecommons_dataset_hint' => 'Datasets that are freely accessible or accessible for registered users require a CC-License to be specified. These are <a href="https://creativecommons.org/licenses/">CreativeCommons.org</a> licenses for data of public access. Choose one of the options carefully. It is recommended to be less restrictive as possible as to maximize the use of the data. <code>CC-BY</code> is recommended, whereby the only applied restriction is attribution of source and/or authorship. Once made publicaly accessible, the Dataset may be distributed by others, as long as the license is respected. The Dataset version in an OpenDataBio installation is dynamic and reflects the most recent edition, either in a measurement value or a measured Individual taxonomic identity if that applies.',
  ...
  'creativecommons_picture_hint' => 'These are <a href="https://creativecommons.org/licenses/">CreativeCommons.org</a>  licenses for data of public access. It is recommended to be less restrictive as possible as to maximize the use of the data.',
  'credits' => 'Credits',
  'current_password' => 'Current Password',
  'dashboard' => 'User dashboard',
  'data_privacy' => 'Data Privacy',
  'dataset_hint' => '<a href="datasets"> Datasets </a> are <code> Measurements </code> of one or more Traits from  Individuals, Taxons, Vouchers and / or Locations. For <code> occurrence data </code> see <a href="projects"> Projects </a>, which control access to this type of data, that is, the Individuals\' records, their taxonomic identities and geographic locations.',
  ...
  'data_policy_hint' =>'Datasets and Projects data my have <code>sui generis database rights</code> under CreativeCommons licenses, which "grant qualifying database makers the right to prohibit the extraction and reuse of a substantial portion of a database. The rights are granted to database makers that make a substantial investment of time and resources to create the database. (...)  Sui generis database rights prevent copying and reusing of substantial parts of a database (including frequent extraction of insubstantial parts). However unlike copyright, database rights protect the maker’s investment, not originality". Choosing a license with an ND option would imply that a "substantial portion of the database contents" cannot be deposited in another publicly shared database under a new "sui generis database rights" for somebody else (see <a href="https://creativecommons.org/faq">CC Frequent questions</a>). Therefore, write here additional data policies for this dataset or project records. This text will be added to the license and by filling this info the system will understand that "Some restrictions may apply". Be careful not to contradict the CC license you selected.',
  ...
  'project_title_hint' => 'Individual occurrence may have a citation, particularly if you choose a CC+BY license, which requires source citation. The Projet Title is used for the citation generation of the individual/occurrences included in this Project. If not informed. The name is used for title. Maximum 191 characters',
  ...
  'hint_biocollections_page' => 'This table contains the registered Biological Collections in which the Voucher can be stored. If the BioCollection is a Biocollection it may have an identification number from the Index Herbariorum, which can be used to retrieve other details such as address, phone, or e-mail of curators. You can register a Biocollection using the acronym, which normally consists of two to five letters and for this case all other fields will be filled in automatically when you Check the Index Herbariorum API. For non-plant collections and biocollections not indexed by Index Herbariorum, you must provide acronym and name',
  ...
  'import_locations_hint' => 'Each line is a location record and may have the following columns: <code>name**, adm_level**, parent, altitude, datum, geom** (or lat and long), uc, x, y, startx, starty, notes</code>. See <a href="'.url('docs/en/API#endpoint_locations').'">API docs</a> for a full list and explanations',
  ...
  'location_hint' => 'These are registered geographical locations in which Individuals or Measurements may be collected. They may be any spatial Polygon or Point geographical location, including a special treatment for Plots, which have specific attributes and may be registered as polygons or points.',
  ...
  'person_hint' => 'This table represent people which may or may not be directly involved with the database. It is used to store information about Individuals, Vouchers and Pictures collectors, specialists and database users. When registering a new person, the system suggests the name abbreviation, but the user is free to change it to better adapt it to the usual abbreviation used by each person. The abbreviation should be unique in the database.',
  ...
  'picture' => 'Picture',
  'pictures' => 'Pictures',
  'picture_date_hint' => 'Optional. The date will be extracted from the image file metadata if present. If not present and not informed current date will be used for the image. This info is used for generating the image citation.',
  ...
  'individual_position_hint' => 'Register here the relative coordinates in respect to the location of the individual. If Location is Point you may provide Angle (=Azimuth) and Distance (meters). If location is a Plot, you may provide X and Y position for the individual in relation to the Plot origin (0,0), just make sure to use the same units of the plot dimensions',
  'individual_project_hint' => 'Under which project do you wish to register this individual? This will affect which users will be able to see this register.',
  'individual_tag' => 'Tag, Number or Code',
  'individual_taxon_hint' => 'Indicate the taxon to which this Individual was identified.',
  'individual_xy_error' => 'The x and y positions must be non-negative and less than the plot dimensions.',
  'individual' => 'Individual',
  'individuals_hint' => 'List of Individuals registered in the database and accessible by you. Individuals are records of occurrence of organisms and can represent individuals monitored over time (e.g. a plant in a plot, a banded bird) or single point observations. Access to records depends on the privacy of the Project data to which the Individual belongs.',
  ...
  'project_privacy_hint' => 'Define access to the Individuals belonging to the Project: a) Restricted users - only users defined as administrators, collaborators  or viewers can view and download Individuals and their Vouchers; b) Registered users - any user with a login in the system can view and download Individuals and their Vouchers; b) Public - everyone can view or download. Note that Datasets may contain measurements for individuals in different projects, and hence have their own policies independent of projects',
  'project' => 'Project',
  'projects_hint' => 'Projects organize and give access to records for Individuals and their Vouchers, i.e. they basically control access and licensing of <code>occurrence data</code>, i.e. the individuals, their taxonomic identity and spatial location. See <a href="datasets"> Datasets </a> for Measurements of custom Traits from Individuals, Taxons, Vouchers and/or Locations',
  'projects' => 'Projects',
  ...
  'taxon_identification_index' => 'The list below include the taxa used as identifications for Individuals. Counts refer to the list scope, except for pictures.',
  ...
  'trait' => 'Trait',
  'traits_hint' => 'Traits are variables that can be measured on individuals, vouchers, locations and taxa. A trait definition must be as precise as possible.',
  'traits' => 'Traits',
  ...
  'voucher' => 'Voucher',
  'vouchers_hint' => 'Vouchers represent specimens or samples in a Biological Collection and belong to an Individual. Individuals may have none or many Vouchers, but each Voucher must always belong to an Individual and a BioCollection. The accessibility of Vouchers records depends on the privacy of the data of the Project in which it is inserted.',
  'vouchers' => 'Vouchers',
