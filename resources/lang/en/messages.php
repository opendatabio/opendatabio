...
return array (
  ...
  'geom' => 'Geometry',
  'help' => 'Help!',
  'herbaria' => 'BioCollections',
  'herbarium_number' => 'Number in the BioCollection',
  'herbarium_reference' => 'BioCollection code',
  'herbarium' => 'BioCollection',
  'here' => 'here',
  ...
  'hint_default_project' => 'If you select a Project here, this will be used as default on all relevant forms, such as when filling in vouchers or plants collected.',
  ...
  'hint_herbaria_page' => 'This table contains the registered Biological Collections in which the Voucher can be stored. If the BioCollection is a Herbarium it may have an identification number from the Index Herbariorum, which can be used to retrieve other details such as address, phone, or e-mail. You can register a Herbarium using the acronym, which normally consists of two to five letters and for this case all other fields will be filled in automatically when you Check the Index Herbariorum API. For non-plant collections and  herbaria that are not indexed by Index Herbariorum, you must provide acronym and name.',
  ...
  'hint_voucher_create' => 'In this screen you can register a new collected Voucher, which may be associated with a Plant or with a Location from which it was collected. If you associate a Voucher to a Location, you must provide the species identification, but if it is a Plant voucher, the identification will be that of the related Plant. The main identifier of the Voucher is the combination of the Main collector and the Collector-Number',
  ...
  'home' => 'Home',
  'id_herbarium' => 'Id based on BioCollection',
  'id' => 'ID',
  ...
  'invalid_herbaria' => 'Informed BioCollection is invalid',
  ...
  'new_herbarium' => 'Register BioCollection',
  ...
  'person_herbarium_hint' => 'Fill this if this person is associated with a BioCollection. He or she will then be listed as a taxonomist specialist.',
  'person_hint' => 'This table represent people which may or may not be directly involved with the database. It is used to store information about Plant, Voucher and Picture collectors, specialists, database users. When registering a new person, the system suggests the name abbreviation, but the user is free to change it to better adapt it to the usual abbreviation used by each person. The abbreviation should be unique for each person.',
  ...
  'plant_herbarium_id_hint' => 'Indicate here if the identification was done based on a comparison with a herbarium sample. If you do so, use the "BioCollection Code" field to indicate the Voucher id of the specimen used for comparison',
  ...
  'plant' => 'Plant',
  'plants_and_vouchers' => 'Plants and voucher specimens',
  ...
  'project' => 'Project',
  'projects_hint' => 'Projects are a way to group together several resources in the database, such as Plants and Vouchers. Each project has a list of administrators, collaborators and viewers. Administrator have full control and access, collaborators have limited control, and viewers have read-only access to the project\'s data.',
  'projects' => 'Projects',
  ...
  'register' => 'Register',
  'registered_herbaria' => 'Registered BioCollections',
  ...
  'remove_herbarium' => 'Remove BioCollection',
  ...
  'trait_export_hint' => 'This name will be used as a label when exporting data. It must be UNIQUE in the database. Please provide a name that is easy to identify. Use CamelCase and avoid diacritics (accents), special characters and even white-spaces.',
  ...
  'trait' => 'Trait',
  'traits_hint' => 'Traits are variables that can be measured on plants, vouchers, locations and taxa. A trait definition must be as precise as possible.',
  'traits' => 'Traits',
  ...
  'userjobs' => 'Jobs',
  'users_hint' => 'This table represent the system users. Each user has a valid e-mail and password, and an access level, which determines the actions he or she may take on the system. This table does not store information about plant or voucher collectors or specialists. Use the "Persons" tab for that.',
  'users' => 'Users',
  ...
  'voucher_herbaria_deposited_hint' => 'To record BioCollection where the voucher is physically deposited.',
  'voucher_herbaria_depositedtable_hint' => 'Table with the BioCollections where the voucher is deposited and their associated id references',
  'voucher_herbaria' => 'BioCollections',
  'voucher_herbarium_id_hint' => 'If the identification was based on a comparison with another specimen deposited in a BioCollection, you may register here the BioCollection acronym and the compared specimen id in this collection "BioCollection code" field. Note that this field should not be used to register where this voucher was stored, use the table below for that.',
  ...
  'voucher_number' => 'Voucher collector-number',
  ...
  'voucher_parent_type_hint' => 'A Voucher specimen may be associated with a marked Plantor with a Location from which it was collected. Please note that if you associate a Voucher to a Location, you must provide the species identification, but if you associate it with a Plant (for plants only, obviously), the identification will be that of Plant as a single plant may have multiple vouchers',
  ...
  'voucher' => 'Voucher',
  'vouchers_hint' => 'This table represent voucher samples, which are either specimens deposited in a Biological Collection or species occurrence records. To register a new specimen proceed to the screen of the location or plant from which the specimen was taken.',
  'vouchers' => 'Vouchers',
