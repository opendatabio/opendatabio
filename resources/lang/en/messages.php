...
remove the job information from the database.',
  ...
  'viewers' => 'Viewers',
  'project_admins_hint' => 'Use these selectors to add users to the administrator, collaborator or viewer lists of this project. Administrator have full control and access, collaborators have limited control, and viewers have read-only access to the project\'s data.',
  ...
  'taxon_senior_level_error' => 'The senior synonym indicated is from a taxonomic level too far from this name.',
  'taxon_senior_valid_error' => 'A name must not be marked as valid if it has a senior synonym.',
  'taxon_senior_invalid_error' => 'The name indicated as senior synonym must be valid.',
