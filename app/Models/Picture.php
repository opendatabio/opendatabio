...
class Picture extends Model
{
    ...
    {
      if ($this->object_type == 'App\Models\Individual' or $this->object_type == 'App\Models\Voucher' ) {
        return $this->object()->withoutGlobalScopes()->first()->taxon_name;
      }
      if ($this->object_type == 'App\Models\Taxon' ) {
    ...
    public function getTitleAttribute()
    {
      ...
      if ($this->object_type == 'App\Models\Location' ) {
